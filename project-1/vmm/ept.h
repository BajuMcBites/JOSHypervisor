...
epte_t* ept_walk_1(epte_t *dir, const void *va, int create, uint64_t perm);
epte_t* ept_walk_2(epte_t *dir, const void *va, int create, uint64_t perm);
epte_t* ept_walk_3(epte_t *dir, const void *va, int create, uint64_t perm);
